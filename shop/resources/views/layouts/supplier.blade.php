...
<body>
        ...
        <div class="layout-container">
            ...
            <div class="layout-page">
                ...
                <nav class="layout-navbar navbar navbar-expand-xl navbar-detached bg-navbar-theme px-3">
                    <div class="navbar-nav-right d-flex align-items-center ms-auto flex-wrap">
                        <!-- User Dropdown -->
                        <ul class="navbar-nav flex-row align-items-center ms-auto">
                            <li class="nav-item dropdown-user dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li>
                                        <a class="dropdown-item" href="{{ route('supplier.akun.index') }}">
                                            <div class="d-flex">
    ...
    <script>
        function showFotoModal(productId) {
            // List foto
            const images = window['fotoProduk' + productId];
            if (!images || !images.length) return;

            // Tampilkan foto pertama sebagai utama
            document.getElementById('modalFotoProduk').src = images[0];

            // List thumb foto kalau ada banyak
            let thumbs = '';
            images.forEach(function(img, idx) {
                thumbs += `<img src="${img}" width="60" height="60" style="object-fit:cover; border-radius:6px; margin:3px; cursor:pointer; border:2px solid #eee" onclick="document.getElementById('modalFotoProduk').src='${img}'">`;
            });
            document.getElementById('fotoProdukList').innerHTML = thumbs;
