...
class OrderController extends Controller
{
    ...
    // Helper untuk generate midtrans_order_id unik
    private function generateMidtransOrderId()
    {
        // Format: ORDER-YYYYMMDD-RANDOM4
        $date = date('Ymd');
    ...
    public function store(Request $request)
    {
        ...
        $midtrans_order_id = $this->generateMidtransOrderId();
